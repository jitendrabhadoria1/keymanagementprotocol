                  ...
                  int f = 0;
						...
						while (files.hasMoreElements()) 
						{
							...
							if(paramname != null)
							{
								...
								String fPath = "C:/Tomcat/webapps/SecureAuthenticatedKeyManagement/Gallery/"+image;
								...
								if (files.hasMoreElements()) 
										{
											...
											if(paramname != null)
											{
													...
													String fPath1 = "C:/Tomcat/webapps/SecureAuthenticatedKeyManagement/Gallery/"+image2;
