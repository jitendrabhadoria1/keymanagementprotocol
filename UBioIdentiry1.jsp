...
<%
				   ArrayList list = new ArrayList();
					...
					String dirName ="C:/Tomcat/webapps/SecureAuthenticatedKeyManagement/Gallery/";
        ...
        while (rs1.next()) { 
            ...
            in.close();
                                         ...
                                         System.out.println("C:/Tomcat/webapps/SecureAuthenticatedKeyManagement/Gallery/"+image);
             File fileA = new File("C:/Tomcat/webapps/SecureAuthenticatedKeyManagement/Gallery/"+image); 
